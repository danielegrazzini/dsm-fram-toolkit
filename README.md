...
- Grazzini, D. (2026). *FEBS: extending the Browning-Eppinger stochastic model with a six-aspect FRAM coupling tensor.* (Extension study; UCAV case, FEBS->B-E reduction, and the formal proof in `data/`.) Working paper.
